"""HTTP client infrastructure for communicating with the Bootstrap Relay from Client."""
...
class BootstrapClient:
    """Handles HTTP communication with the Bootstrap Relay API for Client node."""
    ...
    def register_peer(
        ...
        """Registers client node with Bootstrap relay and returns response data."""
